# https://russianstepbystep.com/wp-content/uploads/2018/06/logo-150.png
...
## Метаданные
- **filename**: logo-150.png
- **ext**: png
- **url**: https://russianstepbystep.com/wp-content/uploads/2018/06/logo-150.png
- **mime**: text/html; charset=UTF-8
- **metadata**: None
- **error**: True
- **msg**: Unable to parse file logo-150.png
- **source**: russianstepbystep.com.warc.gz
